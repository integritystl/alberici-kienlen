...
function alberici_hillsdale_scripts() {
	...
	wp_enqueue_script( 'theme-config', get_template_directory_uri() . '/js/src/theme-config.js', array('jquery'), time(), true );

	wp_localize_script('theme-config', 'theme_config', $theme_config);
